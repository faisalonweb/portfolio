...
export default function Hero() {
  ...
  return (
    <div>
      ...
      >
        <div>
          ...
          <motion.h1
            ...
            onMouseEnter={textEnter}
            onMouseLeave={textLeave}
            className="md:text-[4.1rem] text-[1rem]  leading-[1.2] font-bold"
          >
            Faisal Usman
          </motion.h1>
          <motion.h1
      ...
      <div className="flex flex-col ml-12 mt-[80px] fixed bottom-0 ">
      ...
      <div className="flex flex-col mt-[80px] fixed bottom-0 right-0">
        <div className="h-[57px]">
          <p className="rotate-90 text-[8px]  text-gray-500">
            faisalusman390@gmail.com
          </p>
        </div>
